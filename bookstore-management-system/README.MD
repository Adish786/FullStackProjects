...
Bookstore Management System
A fullstack application for managing bookstore operations built with Spring Boot 6, JDK 21, and React Vite.
...
cd bookstore-management-system/backend
Configure database
...
The application will automatically create tables on first run. Sample data can be loaded using:
